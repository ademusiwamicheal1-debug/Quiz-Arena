...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-200 transition-colors font-sans flex flex-col">
      {/* Top Navigation Bar */}
      <Navbar
        activeTab={activeTab}
        setActiveTab={tab => {
      ...
      <main className="pt-4 flex-1">
        ...
        {!activeQuizPack && !quizResults && activeTab === 'explore' && (
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            {/* Hero Banner */}
            <div className="relative rounded-xl p-6 sm:p-8 mb-8 overflow-hidden bg-slate-900 text-white shadow-xl border border-slate-800">
              <div className="relative z-10 max-w-2xl">
                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-indigo-500/20 text-indigo-400 font-bold text-xs uppercase tracking-wider mb-4 border border-indigo-500/30 font-mono">
                  <Zap className="w-3.5 h-3.5 text-orange-400" /> 30-Second Rapid-Fire Academic & General Arena
                </div>
                ...
                <div className="flex flex-wrap items-center gap-3">
                  <button
                    ...
                    className="px-5 py-2.5 rounded-lg font-bold text-xs bg-indigo-600 hover:bg-indigo-500 text-white shadow-lg transition-all flex items-center gap-2"
                  >
                  ...
                  <button
                    ...
                    className="px-5 py-2.5 rounded-lg font-bold text-xs bg-white hover:bg-slate-100 text-slate-900 shadow-lg transition-all flex items-center gap-2 border border-slate-200"
                  >
                    {currentUser ? (
                      <>
            ...
            <div className="flex flex-col md:flex-row items-center justify-between gap-4 mb-6">
              ...
              <div className="relative w-full md:w-80">
                <input
                  ...
                  className="w-full pl-10 pr-4 py-2.5 rounded-lg bg-slate-900 border border-slate-800 text-xs font-semibold text-slate-200 placeholder-slate-500 focus:outline-none focus:ring-1 focus:ring-indigo-500 shadow-sm"
                />
              ...
              <div className="flex items-center gap-3 w-full md:w-auto">
                <div className="flex items-center gap-2 bg-slate-900 p-1.5 rounded-lg border border-slate-800 shadow-sm w-full md:w-auto">
                  <Filter className="w-4 h-4 text-slate-500 ml-2 shrink-0" />
                  <select
                    value={selectedCategory}
                    onChange={e => setSelectedCategory(e.target.value)}
                    className="bg-transparent text-xs font-semibold text-slate-300 focus:outline-none p-1 max-w-[200px]"
                  >
                  ...
                  <select
                    ...
                    className="bg-transparent text-xs font-semibold text-slate-300 focus:outline-none p-1 border-l border-slate-800"
                  >
      ...
      <footer className="h-12 bg-slate-900 border-t border-slate-800 px-6 sm:px-8 flex items-center justify-between text-[10px] text-slate-500 font-bold uppercase tracking-[0.2em] font-mono mt-auto">
